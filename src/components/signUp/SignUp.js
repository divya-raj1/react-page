    ...
    return (
        <Form validated={validated} noValidate onSubmit={handleSubmit} className="register-form">
            ...
            <Form.Group className="mb-3" controlId="formBasicEmail">
                ...
                <Form.Control type="email" ref={email} pattern=".+@[a-zA-Z0-9.-]+\.[a-zA-Z]{2,4}" required/>
            ...
            <Form.Group className="mb-3" controlId="formBasicPassword">
                ...
                <Form.Control type="password" pattern="(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}" required/>
                <Form.Control.Feedback type="invalid">
                    Must be 8 or more characters and containe atleast one number and one special character.
                </Form.Control.Feedback>
                <Form.Control.Feedback type="valid">Looks good!</Form.Control.Feedback>
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicContact">
                <Form.Label>Contact</Form.Label>
                <Form.Control type="tel" required pattern="[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}"/>
                <Form.Control.Feedback type="invalid">
                    Please provide valid contact.
                </Form.Control.Feedback>
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicLocation">
                <Form.Label>Location</Form.Label>
                <Form.Select defaultValue="" aria-label="Default select example" required>
